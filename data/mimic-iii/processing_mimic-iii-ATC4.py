...
def create_str_token_mapping(df):
    ...
    dill.dump(obj={'diag_voc':diag_voc, 'med_voc':med_voc ,'pro_voc':pro_voc}, file=open('ATC4_voc_final.pkl','wb'))
...
def create_patient_record(df, diag_voc, med_voc, pro_voc):
    ...
    dill.dump(obj=records, file=open('ATC4_records_final.pkl', 'wb'))
    return records
...
def get_ddi_matrix(records, med_voc, ddi_file):
    ...
    for item in med_unique_word:
        atc3_atc4_dic[item[:5]].add(item)   # 其实这个地方能很好的控制ATC4和ATC3的转换
    ...
    dill.dump(ehr_adj, open('ATC4_ehr_adj_final.pkl', 'wb'))
    ...
    dill.dump(ddi_adj, open('ATC4_ddi_A_final.pkl', 'wb'))
...
if __name__ == '__main__':
    ...
    print("proc_pd.head(20)")
    print(pro_pd.head(20))
    print("")
    ...
    data.to_pickle('ATC4_data_final.pkl')
    ...
    ddi_rate = ddi_rate_score(records, "ATC4_ddi_A_final.pkl")
